                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-outline mb-3" style="border: black 1px">
                      <select name="status" class="form-control" id="status">
                        <option value="">---Please Select---</option>
                        <option {{ old('status') == '-1' ? 'selected' : '' }} value="0">Đã nghỉ việc</option>
                        <option {{ old('status') == '1' ? 'selected' : '' }} value="1">Đang làm việc</option>
                      </select>
                    </div>
                    @error('status')
                      <span class="text-danger">{{ $message }}<span>
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-outline mb-3" style="border: black 1px">
                      <select name="role" class="form-control" id="role">
                        <option value="">---Please Select---</option>
                        <option {{ old('role') == '0' ? 'selected' : '' }} value="0">Admin</option>
                        <option {{ old('role') == '1' ? 'selected' : '' }} value="1">Nhân viên</option>
                        <option {{ old('role') == '2' ? 'selected' : '' }} value="2">Quản lí</option>
                      </select>
                    </div>
                    @error('role')
                      <span class="text-danger">{{ $message }}<span>
