...
<nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
    <div class="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        ...
        <h6 class="font-weight-bolder mb-0">Edit phòng ban</h6>
      </nav>
      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Edit phòng ban</h3>
            </div>
            @if (session('message'))
              <div class="row">
                  <div class="col-md-12">
            ...
            <div class="card card-plain">
              <div class="card-body">
                <form role="form" method="post" action="{{ route('admin.department.update', ['departmentid' => $data->id]) }}" >
                  ...
                  <div class="form-group">
                    <label for="code">Tên phòng ban</label>
                    <div class="input-group input-group-outline mb-3">
                      <input type="text" value="{{ old('name') ?? $data['name'] }}" name="name" class="form-control" id="name" placeholder="Tên phòng ban">
                    </div>
                  </div>
                  @error('name')
                    <span class="text-danger">{{ $message }}<span>
