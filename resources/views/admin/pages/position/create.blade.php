      ...
      <div class="col-md-12">
        ...
        <div class="card card-primary">
            <div class="card-header">
              <h3 class="card-title">Tạo chức vụ</h3>
            </div>
            @if (session('message'))
              <div class="row">
                  <div class="col-md-12">
                ...
                <form role="form" method="POST" action="{{ route('admin.position.store') }}" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <input type="text"  name="code" class="form-control" placeholder="Mã chức vụ">
                    </div>
                  </div>
                  @error('code')
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group input-group-outline mb-3">
                      <input type="text"  name="name" class="form-control" placeholder="Tên chức vụ">
                    </div>
                  </div>
                  @error('name')
                    <span class="text-danger">{{ $message }}<span>
